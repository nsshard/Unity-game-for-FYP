...
public class dividestagehandler2 : MonoBehaviour
{
...
public AudioSource rightanswersounde;
 ...
 void Start () {
     ...
     float setA = Random.Range(10, 40);
     float setB = Random.Range(2, 8);
    float answer = (Mathf.Round(setA/setB));
  ...
  question.text = "What is " + setA + " / " + setB; 
     ...
     void checktheanswer()
    {
       if(playeranswer.text== "" || playeranswer.text=="." || playeranswer.text==".." || playeranswer.text=="...")
 {
